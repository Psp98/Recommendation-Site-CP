...
@WebServlet("/problem_tags")
public class Problems_as_per_tags extends HttpServlet {
    @Override
    public void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        String u_name = "Psp_98";

        String s1 = "<!doctype html><html lang=\"en\"><head><meta charset=\"UTF-8\"><title>Problem_Tags</title>" +
                "<link rel=\"stylesheet\" type=\"text/css\" href=\"problems_as_per_tags_java.css\"></head><body>";
        String s2 = "</body></html>";
